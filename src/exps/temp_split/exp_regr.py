...
train_data = pd.read_csv("Data/csv/temp_split/train_data-regr.csv")
test_data  = pd.read_csv("Data/csv/temp_split/test_data-regr.csv")
...
if exp_n==0:
	...
	EXP_NAME = "temp_split_regr-std"
elif exp_n == 1:
	scaler = MinMaxScaler()
	EXP_NAME = "temp_split_regr-min_max"
elif exp_n == 2:
	scaler = RobustScaler()
	EXP_NAME = "temp_split_regr-robust_scaler"
elif exp_n == 9:
	PCA_b = True
	EXP_NAME = "temp_split_regr-PCA"
...
def mlp_exp():
	...
	exp = Experiment(mlp, train_x, train_data["vs"], test_x, test_data["vs"],
					 exp_name=EXP_NAME, model_name="MLP_big", grid_search=grid_search)
...
# adaboost_mlp_exp()
# gboost_exp()
#gp_sim_exp() # Va bastante regular !!
